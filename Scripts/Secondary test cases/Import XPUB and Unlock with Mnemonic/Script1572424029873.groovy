...
Mobile.sendKeys(findTestObject('App/Wallets/input - Address key mnemonic'), GlobalVariable.xpub_dragon)
...
Mobile.sendKeys(findTestObject('App/General/android.widget.EditText0 - Backup phrase'), GlobalVariable.mnemonic_dragon)
