...
Mobile.sendKeys(findTestObject('First tests/Wallets/(enter)android.widget.EditText0 - Address key mnemonic'), GlobalVariable.address_dragon)
...
Mobile.sendKeys(findTestObject('First tests/General/android.widget.EditText0 - Backup phrase'), GlobalVariable.xprv_dragon)
