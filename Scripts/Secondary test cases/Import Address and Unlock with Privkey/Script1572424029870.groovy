...
Mobile.sendKeys(findTestObject('First tests/Wallets/(enter)android.widget.EditText0 - Address key mnemonic'), GlobalVariable.unlock_adr)
...
Mobile.sendKeys(findTestObject('First tests/General/android.widget.EditText0 - Backup phrase'), GlobalVariable.privkey_stone)
