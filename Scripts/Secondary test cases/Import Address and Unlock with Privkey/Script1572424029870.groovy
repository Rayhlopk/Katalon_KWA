...
Mobile.sendKeys(findTestObject('Smoke test/Wallets/(enter)android.widget.EditText0 - Address key mnemonic'), GlobalVariable.unlock_adr)
...
Mobile.sendKeys(findTestObject('Smoke test/General/android.widget.EditText0 - Backup phrase'), GlobalVariable.privkey_stone)
